  ...
  <div style="text-align: center">
    ...
    <div id="custom-area">
      <p><label for="text">Paste your text below!</label>
        <p><textarea id="text" bind:value={text}/>
  ...
  <div style="float: left">
    <p><label>Spiral:</label>
      ...
      <p><label for="scale">Scale:</label>
        ...
        <label for={scale.id}><input type="radio" name="scale" id={scale.id} value={scale.id} checked="checked" bind:group={fontScale}> {scale.legend}</label>
        {/each}
